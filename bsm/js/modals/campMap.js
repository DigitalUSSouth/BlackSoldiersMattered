$('#campsModal').on('shown.bs.modal', function()
  {
    if (campsModalDisplayed) return; //if the modal has been opened before we don't want to redraw everything
    campsModalDisplayed = true;
